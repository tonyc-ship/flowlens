...
from clawvision.core.runtime import load_runtime_env
from clawvision.perception.media import MediaConfig, MediaProcessor
...
def build_cases() -> list[BenchCase]:
    xhs_search_img = (
        "/Users/tonychong/Library/Application Support/com.clawvision.desktop/task_runs/"
