...
from clawvision.vision.llm import VisionLLM, VisionRequestConfig
...
class VisionRequestConfigTest(unittest.TestCase):
    ...
    def test_explicit_local_model_name_is_not_forced_back_to_default(self) -> None:
        ...
        with mock.patch("clawvision.agent.local_llm.LocalLLM.is_available", return_value=False):
    ...
    def test_local_model_is_available_rejects_partial_download(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            with mock.patch("clawvision.agent.local_llm.WEIGHTS_DIR", weights_dir):
