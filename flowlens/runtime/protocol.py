"""Typed JSON-RPC protocol models for the FlowLens Python runtime sidecar.

Pydantic is intentionally used at this process boundary because Rust/Tauri sends
untyped JSON into the Python runtime. Internal FlowLens domain models can remain as
