"""Service methods for the Socai Python runtime sidecar.

The Tauri app talks to this module through JSON-RPC over stdio. Runtime actions
call importable Socai packages directly; the old app-local prototype path is
...
from socai.cdp.discovery import INSPECT_URL, discover_chrome_cdp
from socai.cdp.targets import TargetListConfig, list_chrome_targets
from socai.platforms.xhs.cdp_diagnostics import XHS_SUCCESS_STATUSES, XHSCdpProbeConfig, run_xhs_cdp_probe
