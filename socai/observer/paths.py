...
LAUNCH_AGENT_LABEL = "com.socai.observer"
...
class ObserverPaths:
    ...
    def resolve(cls, root: str | Path | None = None) -> "ObserverPaths":
        ...
        elif os.environ.get("SOCAI_OBSERVER_ROOT"):
            base = Path(os.environ["SOCAI_OBSERVER_ROOT"]).expanduser()
        elif os.environ.get("SOCAI_APP_DATA_DIR"):
            base = Path(os.environ["SOCAI_APP_DATA_DIR"]).expanduser() / "observer"
        else:
